...
function MemberAvatar({
  ...
  if (avatarUrl) {
    return (
      <div className="w-20 h-20 rounded-full border-2 border-brand-primary/20 overflow-hidden mb-4 flex-shrink-0">
        <Image
          src={avatarUrl}
  ...
  return (
    <div className="w-20 h-20 rounded-full border-2 border-brand-primary/20 bg-brand-primary flex items-center justify-center mb-4 flex-shrink-0">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {members.map((member) => (
          <div
            key={member.id}
            className="bg-neutral-100 dark:bg-neutral-900 rounded-xl p-6 hover:shadow-md transition-shadow flex flex-col items-center text-center"
          >
            <MemberAvatar
