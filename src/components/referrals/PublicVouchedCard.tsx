...
import type { SafePublicVouchedProfile } from "@/services/referrals/public-vouched-profile";

type Props = Readonly<{ profile: SafePublicVouchedProfile }>;

export function PublicVouchedCard({ profile }: Props) {
  return (
