  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        {/* Commission */}
        {commission > 0 && (
          <div className="mt-3 flex items-center gap-1.5 rounded-lg bg-amber-50 px-3 py-2 dark:bg-amber-900/20">
            <Banknote className="size-3.5 text-amber-600 dark:text-amber-400" strokeWidth={1.25} />
