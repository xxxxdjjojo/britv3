 ...
 * and asserting the route still loads and the handler still runs. This lives in
 * its own file (no message-service mock) so the route's REAL import graph is
 * exercised — that is the whole point of the regression.
 */
