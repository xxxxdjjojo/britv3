...
// 1 GDPR export per hour per user (fail-closed for security)
const gdprExportLimiter = createAuthRateLimiter(1, "1 h");
...
export async function GET() {
  ...
  // Rate limit: 1 export per hour per user (fail-closed for security)
