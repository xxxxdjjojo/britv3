  ...
  try {
    ...
    return (
      <div className="p-6 max-w-7xl">
        <h1 className="text-2xl font-bold font-heading text-brand-primary">Jobs Overview</h1>
    ...
    <div className="p-6 space-y-8 max-w-7xl">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-white shadow-sm flex items-center justify-between">
          ...
          <div className="w-12 h-12 bg-brand-primary-lighter rounded-xl flex items-center justify-center text-brand-primary">
        ...
        <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-white shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            <h3 className="text-3xl font-bold text-brand-primary font-heading">{monthlyEarnings}</h3>
            <p className="text-xs text-neutral-500 flex items-center gap-1 font-semibold">
              <Clock className="size-3" />
              82% of monthly target
            </p>
          </div>
          <div className="w-12 h-12 bg-warning-light rounded-xl flex items-center justify-center text-warning">
        ...
        <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-white shadow-sm flex items-center justify-between">
          ...
          <div className="w-12 h-12 bg-brand-accent-light rounded-xl flex items-center justify-center text-brand-accent">
      ...
      <section className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white p-3 rounded-xl shadow-sm border border-neutral-200">
        <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0">
          <Link
            ...
            className="whitespace-nowrap px-4 py-2 bg-brand-primary text-white rounded-lg text-sm font-semibold shadow-sm"
          >
            All Jobs
          </Link>
          <Link
      ...
      <section className="bg-white rounded-2xl border border-neutral-200 overflow-hidden shadow-sm">
        <div className="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
          <h2 className="text-sm font-bold text-brand-primary font-heading uppercase tracking-widest">
            Upcoming Jobs
          </h2>
          <Link
            href="/dashboard/provider/jobs/active"
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-8">
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6 space-y-4">
          <div className="flex justify-between items-center">
            <h4 className="font-bold text-brand-primary font-heading">Recent Activity</h4>
            <Link
        ...
        <div className="relative bg-brand-primary rounded-2xl overflow-hidden min-h-[200px] flex items-end">
          <div className="absolute inset-0 bg-gradient-to-br from-brand-primary to-brand-primary-dark opacity-80" />
          <div className="relative p-6 w-full">
            <div className="flex justify-between items-end">
              <div>
                <p className="text-xs font-bold text-brand-primary-lighter uppercase tracking-widest mb-1">
                  Service Coverage
                </p>
                <h4 className="text-xl font-bold text-white font-heading">
                  {businessName ?? "Your Service Area"}
                </h4>
                <p className="text-sm text-brand-primary-lighter/70 mt-1">
            ...
            {cashPosition && (
              <div className="mt-4 flex items-center gap-4 pt-4 border-t border-white/10">
                <div>
                  <p className="text-xs text-brand-primary-light font-medium">Cash In</p>
                  <p className="text-base font-bold text-white">
                    £{(cashPosition.receivedPence / 100).toLocaleString("en-GB")}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-brand-primary-light font-medium">Outstanding</p>
                  <p className="text-base font-bold text-white">
