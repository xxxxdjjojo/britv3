  ...
  try {
    ...
    return (
      <div className="p-6 max-w-5xl">
        <h1 className="font-heading text-2xl font-bold text-foreground">Generate Invoice</h1>
        <p className="mt-4 text-sm text-muted-foreground">Unable to load invoice data. Please try refreshing the page.</p>
      </div>
    );
  }
}
