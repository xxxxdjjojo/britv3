...
export default async function NationalMarketTrendsPage() {
  ...
  return (
    <>
      ...
      {/* Breadcrumb */}
      <nav className="max-w-7xl mx-auto px-6 pt-6 pb-2 text-xs text-neutral-500" aria-label="Breadcrumb">
        <ol className="flex items-center gap-1.5">
          <li><Link href="/" className="hover:text-primary transition-colors">Home</Link></li>
          <li>/</li>
          <li><Link href="/market-trends" className="hover:text-primary transition-colors">Market Trends</Link></li>
          <li>/</li>
          <li className="text-neutral-800 dark:text-neutral-200 font-medium">National</li>
        </ol>
      </nav>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-8">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            <div
              key={label}
              className="bg-white dark:bg-neutral-900 border border-primary/10 rounded-xl p-4 flex flex-col gap-1"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 pb-8">
        <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">First-Time Buyers</h2>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-10">
        <div className="bg-white dark:bg-neutral-900 border border-primary/10 rounded-2xl p-6">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-10">
        <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">Regional Comparison</h2>
        <div className="bg-white dark:bg-neutral-900 border border-primary/10 rounded-2xl overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-primary/10 bg-primary/5">
                  <th className="text-left px-4 py-3 font-semibold text-neutral-600 dark:text-neutral-400">Region</th>
                  <th className="text-right px-4 py-3 font-semibold text-neutral-600 dark:text-neutral-400">Avg Price</th>
                  <th className="text-right px-4 py-3 font-semibold text-neutral-600 dark:text-neutral-400">YoY</th>
                  <th className="text-right px-4 py-3 font-semibold text-neutral-600 dark:text-neutral-400 hidden sm:table-cell">Transactions</th>
                  <th className="text-right px-4 py-3 font-semibold text-neutral-600 dark:text-neutral-400 hidden md:table-cell">Days to Sell</th>
                </tr>
              </thead>
              <tbody>
                {regions.map((r, i) => {
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-3">
                        <Link
                          href={`/areas/${citySlug}`}
                          className="font-semibold text-neutral-900 dark:text-neutral-100 hover:text-primary transition-colors"
                        >
                          {r.region}
                        </Link>
                      </td>
                      ...
                      <td className="px-4 py-3 text-right text-neutral-600 dark:text-neutral-400 hidden md:table-cell">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <h2 className="text-xl font-bold mb-4 text-neutral-900 dark:text-neutral-100">Data Sources</h2>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-16">
        <h2 className="text-xl font-bold mb-4 text-neutral-900 dark:text-neutral-100">Explore More</h2>
