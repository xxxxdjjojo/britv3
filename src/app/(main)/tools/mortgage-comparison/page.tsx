      ...
      <div className="border-b border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
        <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-neutral-500">
            <Link href="/tools" className="transition-colors hover:text-brand-primary">
              Tools
            </Link>
      ...
      <header className="border-b border-neutral-200 bg-white py-12 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto max-w-2xl text-lg text-neutral-600 dark:text-neutral-400">
            Compare illustrative mortgage products side by side. Enter your
            property price and deposit to see estimated monthly payments across
            major UK lenders.
          </p>
        </div>
      </header>
