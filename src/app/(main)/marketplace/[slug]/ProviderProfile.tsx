              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div
                      key={i}
                      className="aspect-[4/3] rounded-xl bg-[--color-surface-container-low] dark:bg-slate-800 border border-[--color-outline-variant] dark:border-slate-700 flex items-center justify-center text-sm text-muted-foreground"
                    >
                      Project photo {i}
                    </div>
                  ))}
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="border-b border-[--color-outline-variant] dark:border-slate-700">
                    ...
                    <tbody>
                      {Object.keys(provider.pricing).length > 0 ? (
                        Object.entries(provider.pricing).map(([key, value]) => (
                          <tr key={key} className="border-b border-[--color-outline-variant] dark:border-slate-800">
