...
export default async function MarketplaceLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <input
              ...
              className="flex-1 px-4 py-3 rounded-lg text-neutral-900 placeholder-neutral-400 text-sm focus:outline-none focus:ring-2 focus:ring-white"
            />
            <button
              type="submit"
              className="px-6 py-3 bg-white text-brand-accent font-semibold rounded-lg hover:bg-neutral-50 transition-colors"
            >
              Search
            </button>
          </form>
      ...
      {/* Stats bar */}
      <section className="bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 py-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {CATEGORIES.map(({ slug, label, icon: Icon, href }) => (
            <a
              key={slug}
              href={href}
              className="group flex flex-col items-center p-6 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 hover:border-brand-accent hover:shadow-md transition-all"
            >
              <div className="w-12 h-12 rounded-full bg-brand-accent-light dark:bg-brand-accent/20 flex items-center justify-center mb-3 group-hover:bg-brand-accent/10 dark:group-hover:bg-brand-accent/30 transition-colors">
                <Icon className="w-6 h-6 text-brand-accent" />
              </div>
              <span className="font-semibold text-neutral-900 dark:text-white text-sm text-center">
                {label}
              </span>
              ...
              {featured.map((item) => {
                ...
                return (
                  <a
                    ...
                    className="flex items-start gap-4 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-5 hover:border-brand-accent hover:shadow-md transition-all"
                  >
                    {/* Avatar */}
                    <div className="w-14 h-14 rounded-full bg-neutral-200 dark:bg-neutral-700 flex-shrink-0 overflow-hidden flex items-center justify-center">
                      {profile.avatar_url ? (
                        <img
      ...
      <section className="max-w-7xl mx-auto px-6 pb-0 pt-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-8">
            <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Need a tradesperson?</h3>
            <p className="text-neutral-600 dark:text-neutral-400 mb-5 text-sm">Post your job for free and get quotes from up to 5 verified professionals.</p>
          ...
          <div className="bg-neutral-50 dark:bg-neutral-900/50 rounded-xl border border-neutral-200 dark:border-neutral-700 p-8">
            <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Are you a tradesperson?</h3>
            <p className="text-neutral-600 dark:text-neutral-400 mb-5 text-sm">Browse jobs posted by homeowners in your area and send quotes directly.</p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-brand-primary to-brand-accent rounded-2xl p-10 text-center text-white">
          ...
          <Link
            ...
            className="inline-block px-8 py-3.5 bg-white text-brand-accent font-semibold rounded-lg hover:bg-neutral-50 transition-colors"
          >
            List Your Business
          </Link>
        </div>
