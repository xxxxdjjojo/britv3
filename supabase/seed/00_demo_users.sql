...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    (
      ...
      'james.buyer@demo.truedeed.co.uk',
      v_password,
      v_now,
    ...
    (
      ...
      '00000000-0000-0000-0000-000000000000',
      'authenticated', 'authenticated',
      'sophie.renter@demo.truedeed.co.uk',
      v_password,
      v_now,
    ...
    (
      ...
      '00000000-0000-0000-0000-000000000000',
      'authenticated', 'authenticated',
      'david.seller@demo.truedeed.co.uk',
      v_password,
      v_now,
    ...
    (
      ...
      '00000000-0000-0000-0000-000000000000',
      'authenticated', 'authenticated',
      'mike.landlord@demo.truedeed.co.uk',
      v_password,
      v_now,
    ...
    (
      ...
      '00000000-0000-0000-0000-000000000000',
      'authenticated', 'authenticated',
      'sarah.agent@demo.truedeed.co.uk',
      v_password,
      v_now,
    ...
    (
      ...
      '00000000-0000-0000-0000-000000000000',
      'authenticated', 'authenticated',
      'tom.provider@demo.truedeed.co.uk',
      v_password,
      v_now,
