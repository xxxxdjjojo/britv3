-- ============================================================================
-- RPC: get_landlord_portfolio_properties
-- Returns per-property summary rows for the landlord portfolio page.
-- Replaces in-memory aggregation in portfolio-service.ts getPortfolio().
-- ============================================================================
