...
ALTER TABLE properties
  ...
  ADD COLUMN IF NOT EXISTS hmo_licence_number TEXT,
  ADD COLUMN IF NOT EXISTS hmo_licence_expiry DATE;

CREATE INDEX IF NOT EXISTS idx_properties_is_hmo ON properties(is_hmo) WHERE is_hmo = TRUE;
